...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../upload/temp/'.date("Y").'/'.date("m").'/'.date("d").'/',
            'upload_url' => $this->get_full_url().'/../upload/temp/'.date("Y").'/'.date("m").'/'.date("d").'/',
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error,
        ...
        $name = $this->_translit_file_name($name);
    ...
    protected function _translit_file_name($st, $charset = 'utf-8'){
        // Заменяем проблемные символы для CSS url() - скобки и др.
        $st = str_replace(array('(', ')', '[', ']', '{', '}', ' ', "'", '"'), array('_', '_', '_', '_', '_', '_', '_', '', ''), $st);
