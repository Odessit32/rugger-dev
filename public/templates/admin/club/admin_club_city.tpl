	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			...
			<td width="25%" id="active"><a href="?show=club&get=city">Города</a></td>
	...
	<br>
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			...
			<tr>
				<td width="33%" id="{if $smarty.get.get == 'city'}active_left{else}notactive{/if}"><a href="?show=club&get=city">Список</a></td>
				<td width="34%" id="{if $smarty.get.get == 'cityedit'}active{else}notactive{/if}">{if $smarty.get.item>0}<a href="?show=club&get=cityedit&item={$smarty.get.item}">Редактировать</a>{else}Редактировать{/if}</td>
				<td width="33%" id="{if $smarty.get.get == 'cityadd'}active_right{else}notactive{/if}"><a href="?show=club&get=cityadd">Добавить</a></td>
			</tr>
		</table>
	...
	{if $smarty.get.get == 'city'}
		...
		<center>
		{if $club_city_list and $club_country_list}
			<table width="80%" cellspacing="0" cellpadding="0" border="0" id="form_input">
			{foreach item=item_country from=$club_country_list name=club_country}{if $item_country.cn_id > 0}
				...
				{foreach key=key item=item from=$club_city_list name=club_city}
				{if $item_country.cn_id == $item.ct_cn_id}
					<tr onmouseover="javascript: this.style.background = '#eee'" onmouseout="javascript: this.style.background = ''">
						<td><a href="?show=club&get=cityedit&item={$item.ct_id}">{if $item.ct_title_ru == ''}<font style="color: #f00;">Без названия</font>{else}{$item.ct_title_ru}{/if}</a></td>
					...
					<td width="50%">
						...
						<tr>
							...
							<td width="50%" align="center">
								...
								{foreach key=key item=item from=$club_country_list name=country}{if $item.cn_id > 0}
	...
	{if $smarty.get.get == 'cityedit'}
		<h1>Редактирование страны: &laquo;{$city_item.ct_title_ru}&raquo;</h1>
		<center>
		<form method="post">
		...
		<div id="cont_1">
			...
			<table width="80%" cellspacing="0" cellpadding="0" border="0" id="form_input">
				<tr>
					<th width="20%" align="center">Название (РУС): </th>
					<td width="80%" colspan="3"><input type="text" name="ct_title_ru" value="{$city_item.ct_title_ru}" id="input100"></td>
				</tr>
				<tr><td colspan="2" width="100%" align="center"><b>Описание (РУС):</b> <br><textarea name="ct_description_ru" rows="5" style="width: 100%;">{$city_item.ct_description_ru}</textarea></td></tr>
			</table>
		</div>
		<div id="cont_2">
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
			...
			<table width="80%" cellspacing="0" cellpadding="0" border="0" id="form_input">
				<tr>
					<th width="20%" align="center">Название (УКР): </th>
					<td width="80%" colspan="3"><input type="text" name="ct_title_ua" value="{$city_item.ct_title_ua}" value="{$page_item.p_title_ua}" id="input100"></td>
				</tr>
				<tr><td colspan="2" width="100%" align="center"><b>Описание (УКР):</b> <br><textarea name="ct_description_ua" rows="5" style="width: 100%;">{$city_item.ct_description_ua}</textarea></td></tr>
			</table>
		</div>
		<div id="cont_3">
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
			...
			<table width="80%" cellspacing="0" cellpadding="0" border="0" id="form_input">
				<tr>
					<th width="20%" align="center">Название (ENG): </th>
					<td width="80%" colspan="3"><input type="text" name="ct_title_en" value="{$city_item.ct_title_en}" id="input100"></td>
				</tr>
				<tr><td colspan="2" width="100%" align="center"><b>Описание (ENG):</b> <br><textarea name="ct_description_en" rows="5" style="width: 100%;">{$city_item.ct_description_en}</textarea></td></tr>
			</table>
		</div>
		<div id="cont_4">
