				<table width="100%" cellspacing="0" cellpadding="0" border="0">
					...
					<tr>
						<td width="50%" id="notactive"><a href="?show=games&get=edit&item={$smarty.get.item}&team=owner{if !empty($smarty.get.country)}&country={$smarty.get.country}{/if}{if !empty($smarty.get.ch)}&ch={$smarty.get.ch}{/if}">{$games_item.g_owner_t_title}</a></td>
						<td width="50%" id="active_right"><a href="?show=games&get=edit&item={$smarty.get.item}&team=guest{if !empty($smarty.get.country)}&country={$smarty.get.country}{/if}{if !empty($smarty.get.ch)}&ch={$smarty.get.ch}{/if}">{$games_item.g_guest_t_title}</a></td>
					</tr>
				</table>
				...
				{foreach key=key item=item from=$g_t_staff.guest.main name=main}
					...
					<tr onmouseover="this .style.background='#E4E4E4';" onmouseout="this.style.background='#FFF';">
							...
							{if !empty($g_action.guest.$st_id.zam_out)}{foreach item=item_a from=$g_action.guest.$st_id.zam_out}
								...
								<div id="ga_i_{$item_a.ga_id}" style="display: none; margin: 0; padding: 0;">
									<form method="post" style="margin: 0; padding: 0;">
										...
										<input type="text" name="min" size="3" value="{$item_a.ga_min}" id="input"><input type="submit" style="background: white url(images/yes.jpg) no-repeat center; width: 16px; height: 16px; border: 0; margin: 0 5px 0 0; text-indent: 99px;" value="1" name="edit_g_action">
									</form>
								</div>
								{/if}
							{/foreach}{else}
						...
						<td width="50" valign="bottom" id="{$item.st_id}_pop_A">
							{if !empty($g_action.guest.$st_id.pop)}{foreach item=item_a from=$g_action.guest.$st_id.pop}
						...
						<td width="50" valign="bottom" id="{$item.st_id}_sht_A">
							{if !empty($g_action.guest.$st_id.sht)}{foreach item=item_a from=$g_action.guest.$st_id.sht}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom" id="{$item.st_id}_pez_A">
							{if !empty($g_action.guest.$st_id.pez)}{foreach item=item_a from=$g_action.guest.$st_id.pez}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom" id="{$item.st_id}_d_g_A">
							{if !empty($g_action.guest.$st_id.d_g)}{foreach item=item_a from=$g_action.guest.$st_id.d_g}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom" id="{$item.st_id}_y_c_A">
							{if !empty($g_action.guest.$st_id.y_c)}{foreach item=item_a from=$g_action.guest.$st_id.y_c}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom" id="{$item.st_id}_r_c_A">
							{if !empty($g_action.guest.$st_id.r_c)}{foreach item=item_a from=$g_action.guest.$st_id.r_c}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
					...
					{if !empty($g_t_staff.guest.zam.$st_id.st_id)}
						...
						{if $games_item.g_is_done == 'no'}
							...
							<form method="post">
								...
								<input type="submit" name="edit_g_action" style="background: white url(images/in.gif) no-repeat center; width: 16px; height: 16px; border: 0; margin: 0 5px 0 0; text-indent: 99px;" value="1">
								{else}
								В замене никого нет
								{/if}
							</form>
						...
						<td width="50" valign="bottom" id="{$item_st_id}_pop_A">
							{if !empty($g_action.guest.$item_st_id.pop)}{foreach item=item_a from=$g_action.guest.$item_st_id.pop}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom" id="{$item_st_id}_sht_A">
							{if !empty($g_action.guest.$item_st_id.sht)}{foreach item=item_a from=$g_action.guest.$item_st_id.sht}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom" id="{$item_st_id}_pez_A">
							{if !empty($g_action.guest.$item_st_id.pez)}{foreach item=item_a from=$g_action.guest.$item_st_id.pez}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom" id="{$item_st_id}_d_g_A">
							{if !empty($g_action.guest.$item_st_id.d_g)}{foreach item=item_a from=$g_action.guest.$item_st_id.d_g}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom" id="{$item_st_id}_y_c_A">
							{if !empty($g_action.guest.$item_st_id.y_c)}{foreach item=item_a from=$g_action.guest.$item_st_id.y_c}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom" id="{$item_st_id}_r_c_A">
							{if !empty($g_action.guest.$item_st_id.r_c)}{foreach item=item_a from=$g_action.guest.$item_st_id.r_c}
								<div id="{$item_a.ga_id}" class="edit_b"><a href="javascript: void(0);" onclick="javascript: game_action_edit({$item_a.ga_id}, {$item_a.ga_min})" >{if $item_a.ga_min > 0}{$item_a.ga_min} м.{else}+1 шт.{/if}</a></div>
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
					...
					{if $games_item.g_is_done == 'no'}
						...
						<td>{if $g_t_staff.guest.reserve}<input type="submit" style="background: white url(images/in.gif) no-repeat center; width: 16px; height: 16px; border: 0; margin: 0 5px 0 0; text-indent: 99px" value="1" name="add_g_action">{/if}</td>
						</form>
					{/if}
					{/if}
					</tr>
			...
			{else}
				<br><br>
				Списки команды на игру не определены - <a href="?show=competitions&ch={$games_item.g_ch_id}&get=edit&item={$games_item.g_cp_id}&edit_comp=games_edit&g_item={$games_item.g_id}&cont=5{if !empty($smarty.get.country)}&country={$smarty.get.country}{/if}"><b>их можно определить тут</b></a>.
			{/if}
