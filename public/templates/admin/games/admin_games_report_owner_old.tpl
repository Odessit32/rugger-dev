				<table width="100%" cellspacing="0" cellpadding="0" border="0">
					...
					<tr>
						<td width="50%" id="active_left"><a href="?show=games&get=edit&item={$smarty.get.item}&team=owner">{$games_item.g_owner_t_title}</a></td>
						<td width="50%" id="notactive"><a href="?show=games&get=edit&item={$smarty.get.item}&team=guest">{$games_item.g_guest_t_title}</a></td>
					</tr>
				</table>
				{if $g_t_staff.owner.main}
				...
				{foreach key=key item=item from=$g_t_staff.owner.main name=main}
					...
					<tr onmouseover="this .style.background='#E4E4E4';" onmouseout="this.style.background='#FFF';">
						...
						<td width="50" valign="bottom">
							{if $g_action.owner.$st_id.pop}{foreach item=item_a from=$g_action.owner.$st_id.pop}
								<a href="javascript:void(0);" onclick="document.getElementById('ga_i_{$item_a.ga_id}').style.display='inline'; document.getElementById('ga_a_{$item_a.ga_id}').style.display='none';" style="color: #000;" title="изменить" id="ga_a_{$item_a.ga_id}">{$item_a.ga_min} м.</a>
								{if $games_item.g_is_done == 'no'}
								<div id="ga_i_{$item_a.ga_id}" style="display: none; margin: 0; padding: 0;">
									<form method="post" style="margin: 0; padding: 0;">
							...
							{/foreach}{/if}
							{if $games_item.g_is_done == 'no'}
							<div id="111"><a href="" id="add">&nbsp;</a></div>
						...
						<td width="50" valign="bottom">
							{if $g_action.owner.$st_id.sht}{foreach item=item_a from=$g_action.owner.$st_id.sht}
								<a href="javascript:void(0);" onclick="document.getElementById('ga_i_{$item_a.ga_id}').style.display='inline'; document.getElementById('ga_a_{$item_a.ga_id}').style.display='none';" style="color: #000;" title="изменить" id="ga_a_{$item_a.ga_id}">{$item_a.ga_min} м.</a>
								{if $games_item.g_is_done == 'no'}
						...
						<td width="50" valign="bottom">
							{if $g_action.owner.$st_id.pez}{foreach item=item_a from=$g_action.owner.$st_id.pez}
								<a href="javascript:void(0);" onclick="document.getElementById('ga_i_{$item_a.ga_id}').style.display='inline'; document.getElementById('ga_a_{$item_a.ga_id}').style.display='none';" style="color: #000;" title="изменить" id="ga_a_{$item_a.ga_id}">{$item_a.ga_min} м.</a>
								{if $games_item.g_is_done == 'no'}
								<div id="ga_i_{$item_a.ga_id}" style="display: none; margin: 0; padding: 0;">
									<form method="post" style="margin: 0; padding: 0;">
						...
						<td width="50" valign="bottom">
							{if $g_action.owner.$st_id.d_g}{foreach item=item_a from=$g_action.owner.$st_id.d_g}
								<a href="javascript:void(0);" onclick="document.getElementById('ga_i_{$item_a.ga_id}').style.display='inline'; document.getElementById('ga_a_{$item_a.ga_id}').style.display='none';" style="color: #000;" title="изменить" id="ga_a_{$item_a.ga_id}">{$item_a.ga_min} м.</a>
								{if $games_item.g_is_done == 'no'}
								<div id="ga_i_{$item_a.ga_id}" style="display: none; margin: 0; padding: 0;">
									<form method="post" style="margin: 0; padding: 0;">
						...
						<td width="50" valign="bottom">
							{if $g_action.owner.$st_id.y_c}{foreach item=item_a from=$g_action.owner.$st_id.y_c}
								<a href="javascript:void(0);" onclick="document.getElementById('ga_i_{$item_a.ga_id}').style.display='inline'; document.getElementById('ga_a_{$item_a.ga_id}').style.display='none';" style="color: #000;" title="изменить" id="ga_a_{$item_a.ga_id}">{$item_a.ga_min} м.</a>
								{if $games_item.g_is_done == 'no'}
								<div id="ga_i_{$item_a.ga_id}" style="display: none; margin: 0; padding: 0;">
									<form method="post" style="margin: 0; padding: 0;">
						...
						<td width="50" valign="bottom">
							{if $g_action.owner.$st_id.r_c}{foreach item=item_a from=$g_action.owner.$st_id.r_c}
								<a href="javascript:void(0);" onclick="document.getElementById('ga_i_{$item_a.ga_id}').style.display='inline'; document.getElementById('ga_a_{$item_a.ga_id}').style.display='none';" style="color: #000;" title="изменить" id="ga_a_{$item_a.ga_id}">{$item_a.ga_min} м.</a>
								{if $games_item.g_is_done == 'no'}
								<div id="ga_i_{$item_a.ga_id}" style="display: none; margin: 0; padding: 0;">
									<form method="post" style="margin: 0; padding: 0;">
					...
					{if $g_t_staff.owner.zam.$st_id.st_id > 0}
					...
					{if $games_item.g_is_done == 'no'}
						...
						<td>{if $g_t_staff.owner.reserve}<input type="submit" style="background: white url(images/in.gif) no-repeat center; width: 16px; height: 16px; border: 0; margin: 0 5px 0 0;" value="" name="add_g_action">{/if}</td>
						</form>
					{/if}
					{/if}
					</tr>
