		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			...
			<tr>
				<td width="33%" id="{if (!empty($smarty.get.g_get) && $smarty.get.g_get == 'photos') || empty($smarty.get.g_get)}active_left{else}notactive{/if}"><a href="?show=live&get=edit&item={$smarty.get.item}&cont=4">Список</a></td>
				<td width="34%" id="{if !empty($smarty.get.g_get) && $smarty.get.g_get == 'edit'}active{else}notactive{/if}">{if !empty($smarty.get.g_f_item)}<a href="?show=live&get=edit&item={$smarty.get.item}&cont=4&g_get=edit&g_f_item={$smarty.get.g_f_item}">Редактировать</a>{elseif !empty($smarty.get.g_v_item)}<a href="?show=live&get=edit&item={$smarty.get.item}&cont=4&g_get=edit&g_v_item={$smarty.get.g_v_item}">Редактировать</a>{else}Редактировать{/if}</td>
				<td width="33%" id="{if !empty($smarty.get.g_get) && $smarty.get.g_get == 'add'}active_right{else}notactive{/if}"><a href="?show=live&get=edit&item={$smarty.get.item}&cont=4&g_get=add">Добавить</a></td>
			</tr>
		</table>
	{if empty($smarty.get.g_get)}
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr><td>
			{if !empty($live_photo_list)}
			{foreach key=key item=item from=$live_photo_list name=images}
				<div class="image_item{if $item.ph_type_main == 'yes'}_main{/if}">
					<a href="?show=live&get=edit&item={$smarty.get.item}&cont=4&g_get=edit&g_f_item={$item.ph_id}"><img src="../upload/photos{$item.ph_folder}{$item.ph_path}?{$smarty.now}" width="166"></a>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr><td>
			{if $live_video_list}
			{foreach key=key item=item from=$live_video_list name=images}
				<div class="image_item">
					<a href="?show=live&get=edit&item={$smarty.get.item}&cont=4&g_get=edit&g_v_item={$item.v_id}"><img src="../upload/video_thumbs{$item.v_folder}{$item.v_id}-small.jpg?{$smarty.now}" width="166"></a>
			...
			<table width="95%" cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" id="form_input">
						...
						<tr>
							...
							<select name="ph_gallery_id" id="input100">
								{if $live_photo_gallery}<option value="{$live_photo_gallery.phg_id}" selected>{$live_photo_gallery.phg_title_ru}</option>{else}<option value="new" selected>Новая: {$live_item.l_title_ru}</option>{/if}
								<option value="0">без галереи</option>
							{if $gallery_list}
							{foreach key=key item=item from=$gallery_list name=images}
								{if $live_photo_gallery.phg_id != $item.id}<option value="{$item.id}"{if $item.id == $photo_item.ph_gallery_id} selected{/if}>{$item.title}</option>{/if}
							{/foreach}
							{/if}
							</select>
							</td>
                                ...
                                <select name="phg_phc_id" id="input100">
                                    ...
                                    {if $photo_category_list}
                                        {foreach key=key item=item from=$photo_category_list name=category}
                                            <option value="{$item.phc_id}"{if $live_photo_gallery.phg_phc_id == $item.phc_id} selected="selected"{/if}>{$item.phc_title_ru}</option>
                                        {/foreach}
                                    {/if}
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" align="center">
                                <input id="ph_country_auto_val" type="hidden" name="ph_country_auto_val" value="{$live_item.connection_country_val}">
                                {if $country_list}
                                    ...
                                    {if $live_item.connection_country}
                                        {foreach item=item_cc from=$live_item.connection_country name=connection_country}
                        ...
                        <tr>
                            ...
                            <td width="50%" align="center">
                                <input id="ph_champ_auto_val" type="hidden" name="ph_champ_auto_val" value="{$live_item.connection_champ_val}">
                                {if $champ_list}
                                    ...
                                    {if $live_item.connection_champ}
                                        {foreach item=item_cc from=$live_item.connection_champ name=connection_champ}
					...
					<td width="50%" align="center" valign="middle">
						<input type="submit" name="add_new_live_photo" id="submitsave" value="Добавить">
					</td>
				</tr>
			</table>
			<br>
		...
		<form method="post" enctype="multipart/form-data">
			...
			<table width="95%" cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" id="form_input">
						...
						<tr>
							...
							<select name="v_gallery_id" id="input100">
								{if $live_video_gallery}<option value="{$live_video_gallery.vg_id}" selected>{$live_video_gallery.vg_title_ru}</option>{else}<option value="new" selected>Новая: {$live_item.l_title_ru}</option>{/if}
								<option value="0">без галереи</option>
							{if $gallery_list_video}
							{foreach key=key item=item from=$gallery_list_video name=images}
								{if $live_video_gallery.vg_id != $item.id}<option value="{$item.id}">{$item.title}</option>{/if}
							{/foreach}
							{/if}
							</select>
							</td>
                                ...
                                <select name="vg_vc_id" id="input100">
                                    ...
                                    {if $video_category_list}
                                        {foreach key=key item=item from=$video_category_list name=category}
                                            <option value="{$item.vc_id}"{if $live_video_gallery.vg_vc_id == $item.vc_id} selected="selected"{/if}>{$item.vc_title_ru}</option>
                                        {/foreach}
                                    {/if}
                                </select>
                            </td>
                        ...
                        <tr>
                            <th width="50%" align="center">Страны: </th>
                            <td width="50%" align="center">
                                <input id="v_country_auto_val" type="hidden" name="v_country_auto_val" value="{$live_item.connection_country_val}">
                                {if $country_list}
                        ...
                        <tr>
                            <th width="50%" align="center">Сущность Чемпионаты: </th>
                            <td width="50%" align="center">
                                <input id="v_champ_auto_val" type="hidden" name="v_champ_auto_val" value="{$live_item.connection_champ_val}">
                                {if $champ_list}
					...
					<td width="50%" align="center" valign="middle">
						<input type="submit" name="add_new_live_video" id="submitsave" value="Добавить">
					</td>
				</tr>
			</table>
			<br>
				...
				<tr>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" id="form_input">
						...
						<tr>
							...
							<td width="50%" align="center">
							<select name="ph_gallery_id" id="input100">
								<option value="{$live_photo_gallery.id}"{if $live_photo_gallery.id == $photo_item.ph_gallery_id} selected{/if}>{$live_photo_gallery.title}</option>
								<option value="0"{if $photo_item.ph_gallery_id == 0} selected{/if}>без галереи</option>
							{if $gallery_list}
							{foreach key=key item=item from=$gallery_list name=images}
								{if $live_photo_gallery.id != $item.id}<option value="{$item.id}"{if $item.id == $photo_item.ph_gallery_id} selected{/if}>{$item.title}</option>{/if}
							{/foreach}
							{/if}
							</select>
							</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="phg_phc_id" id="input100">
                                    ...
                                    {if $photo_category_list}
                                        {foreach key=key item=item from=$photo_category_list name=category}
                                            <option value="{if $live_photo_gallery.phg_phc_id == $item.phc_id} selected="selected"{/if}>{$item.phc_title_ru}</option>
                                        {/foreach}
                                    {/if}
                                </select>
                            </td>
					...
					<td width="50%" align="center" valign="middle">
						<input type="submit" name="save_edited_live_photo" id="submitsave" value="Сохранить">
						<br><br><br>
						<input type="submit" name="delete_edited_live_photo" id="submitdelete" value="Удалить">
					</td>
				</tr>
			</table>
			<br>
				...
				<tr>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" id="form_input">
						...
						<tr>
							...
							<td width="50%" align="center">
								<select name="v_gallery_id" id="input100">
									{if $live_video_gallery}<option value="{$live_video_gallery.vg_id}">{$live_video_gallery.vg_title_ru}</option>{else}<option value="new" selected>Новая: {$live_item.l_title_ru}</option>{/if}
									<option value="0"{if $video_item.v_gallery_id == 0} selected{/if}>без галереи</option>
								{if $gallery_list_video}
								{foreach key=key item=item from=$gallery_list_video name=images}
									{if $live_video_gallery.vg_id != $item.id}<option value="{$item.id}"{if $item.id == $video_item.v_gallery_id} selected{/if}>{$item.title}</option>{/if}
								{/foreach}
								{/if}
								</select>
							</td>
                        ...
                        <tr>
                            <th width="50%" align="center">Страны: </th>
                            <td width="50%" align="center">
                                <input id="v_country_auto_val" type="hidden" name="v_country_auto_val" value="{$photo_item.connection_country_val}">
                                {if $country_list}
                                    <select name="country_" id="v_country_auto" class="country_auto">
                                        <option value="">------------</option>
                                        {foreach key=key item=item from=$country_list name=countries_list}
                        ...
                        <tr>
                            <th width="50%" align="center">Сущность Чемпионаты: </th>
                            <td width="50%" align="center">
                                <input id="v_champ_auto_val" type="hidden" name="v_champ_auto_val" value="{$photo_item.connection_champ_val}">
                                {if $champ_list}
                                    <select name="champ_" id="v_champ_auto" class="champ_auto">
                                        <option value="">------------</option>
                                        {foreach key=key item=item from=$champ_list name=countries_list}
					...
					<td width="50%" align="center" valign="middle">
						<input type="submit" name="save_edited_live_video" id="submitsave" value="Сохранить">
						<br><br><br>
						<input type="submit" name="delete_edited_live_video" id="submitdelete" value="Удалить">
					</td>
				</tr>
			</table>
			<br>
			...
			<tr>
				...
				<form method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<br>
						<input type="submit" name="save_edited_live_preview" id="submitsave" value="Перезаписать">
						</td>
					</tr>
				</form>
				</table>
