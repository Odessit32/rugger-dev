		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			...
			<tr>
				<td width="33%" id="{if empty($smarty.get.g_get) || $smarty.get.g_get == 'photos'}active_left{else}notactive{/if}"><a href="?show=news&get=edit&item={$smarty.get.item}&cont=4">Список</a></td>
				<td width="34%" id="{if !empty($smarty.get.g_get) && $smarty.get.g_get == 'edit'}active{else}notactive{/if}">{if !empty($smarty.get.g_f_item)}<a href="?show=news&get=edit&item={$smarty.get.item}&cont=4&g_get=edit&g_f_item={$smarty.get.g_f_item}">Редактировать</a>{elseif !empty($smarty.get.g_v_item)}<a href="?show=news&get=edit&item={$smarty.get.item}&cont=4&g_get=edit&g_v_item={$smarty.get.g_v_item}">Редактировать</a>{else}Редактировать{/if}</td>
				<td width="33%" id="{if !empty($smarty.get.g_get) && $smarty.get.g_get == 'add'}active_right{else}notactive{/if}"><a href="?show=news&get=edit&item={$smarty.get.item}&cont=4&g_get=add">Добавить</a></td>
			</tr>
		</table>
	{if empty($smarty.get.g_get)}
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr><td>
			{if $news_photo_list}
			{foreach key=key item=item from=$news_photo_list name=images}
				<div class="image_item{if $item.ph_type_main == 'yes'}_main{/if}">
					<a href="?show=news&get=edit&item={$smarty.get.item}&cont=4&g_get=edit&g_f_item={$item.ph_id}"><img src="../upload/photos{$item.ph_folder}{$item.ph_path}?{$smarty.now}" width="166"></a>
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr><td>
			{if $news_video_list}
			{foreach key=key item=item from=$news_video_list name=images}
				<div class="image_item">
					<a href="?show=news&get=edit&item={$smarty.get.item}&cont=4&g_get=edit&g_v_item={$item.v_id}"><img src="../upload/video_thumbs{$item.v_folder}{$item.v_id}-small.jpg?{$smarty.now}" width="166"></a>
			...
			<table width="95%" cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" id="form_input">
						...
						<input type="hidden" name="ph_gallery_id" value="{if $news_photo_gallery}{$news_photo_gallery.phg_id}{else}new{/if}">
                        <tr>
                                ...
                                <select name="phg_phc_id" id="input100">
                                    ...
                                    {if $photo_category_list}
                                        {foreach key=key item=item from=$photo_category_list name=category}
                                            <option value="{$item.phc_id}"{if $news_photo_gallery.phg_phc_id == $item.phc_id} selected="selected"{/if}>{$item.phc_title_ru}</option>
                                        {/foreach}
                                    {/if}
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" align="center">
                                <input id="ph_country_auto_val" type="hidden" name="ph_country_auto_val" value="{$news_item.connection_country_val}">
                                {if $country_list}
                        ...
                        <tr>
                            ...
                            <td width="50%" align="center">
                                <input id="ph_champ_auto_val" type="hidden" name="ph_champ_auto_val" value="{$news_item.connection_champ_val}">
                                {if $champ_list}
					...
					<td width="50%" align="center" valign="middle">
						<input type="submit" name="add_new_news_photo" id="submitsave" value="Добавить">
					</td>
				</tr>
			</table>
			<br>
			...
			<table width="95%" cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" id="form_input">
						...
						<input type="hidden" name="v_gallery_id" value="{if $news_video_gallery}{$news_video_gallery.vg_id}{else}new{/if}">
						<tr>
							<th width="50%" align="center">В папку: </th>
							<td width="50%" align="center">
                        ...
                        <tr>
                            <th width="50%" align="center">Страны: </th>
                            <td width="50%" align="center">
                                <input id="v_country_auto_val" type="hidden" name="v_country_auto_val" value="{$news_item.connection_country_val}">
                                {if $country_list}
                        ...
                        <tr>
                            <th width="50%" align="center">Сущность Чемпионаты: </th>
                            <td width="50%" align="center">
                                <input id="v_champ_auto_val" type="hidden" name="v_champ_auto_val" value="{$news_item.connection_champ_val}">
                                {if $champ_list}
					...
					<td width="50%" align="center" valign="middle">
						<input type="submit" name="add_new_news_video" id="submitsave" value="Добавить">
					</td>
				</tr>
			</table>
			<br>
		...
		<form method="post" enctype="multipart/form-data" onsubmit="if (!confirm('Вы уверены?')) return false">
			...
			<table width="95%" cellspacing="0" cellpadding="0" border="0">
				<tr>
					...
					<table width="100%" cellspacing="0" cellpadding="0" border="0" id="form_input">
						...
						<tr>
							...
							<select name="ph_gallery_id" id="input100">
								<option value="{$news_photo_gallery.id}"{if $news_photo_gallery.id == $photo_item.ph_gallery_id} selected{/if}>{$news_photo_gallery.title}</option>
							...
							{foreach key=key item=item from=$gallery_list name=images}
								{if $news_photo_gallery.id != $item.id}<option value="{$item.id}"{if $item.id == $photo_item.ph_gallery_id} selected{/if}>{$item.title}</option>{/if}
							{/foreach}
							{/if}
							</select>
							</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="phg_phc_id" id="input100">
                                    ...
                                    {if $photo_category_list}
                                        {foreach key=key item=item from=$photo_category_list name=category}
                                            <option value="{if $news_photo_gallery.phg_phc_id == $item.phc_id} selected="selected"{/if}>{$item.phc_title_ru}</option>
                                        {/foreach}
                                    {/if}
                                </select>
                            </td>
					...
					<td width="50%" align="center" valign="middle">
						<input type="submit" name="save_edited_news_photo" id="submitsave" value="Сохранить">
						<br><br><br>
						<input type="submit" name="delete_edited_news_photo" id="submitdelete" value="Удалить">
					</td>
				</tr>
			</table>
			<br>
		...
		<form method="post" enctype="multipart/form-data" onsubmit="if (!confirm('Вы уверены?')) return false">
			...
			<table width="95%" cellspacing="0" cellpadding="0" border="0">
				<tr>
						...
						<tr>
							...
							<td width="50%" align="center">
								<select name="v_gallery_id" id="input100">
									{if $news_video_gallery}<option value="{$news_video_gallery.vg_id}">{$news_video_gallery.vg_title_ru}</option>{else}<option value="new" selected>Новая: {$news_item.n_title_ru}</option>{/if}
								...
								{foreach key=key item=item from=$gallery_list_video name=images}
									{if $news_video_gallery.vg_id != $item.id}<option value="{$item.id}"{if $item.id == $video_item.v_gallery_id} selected{/if}>{$item.title}</option>{/if}
								{/foreach}
								{/if}
								</select>
							</td>
                                ...
                                <select name="vg_vc_id" id="input100">
                                    ...
                                    {if $video_category_list}
                                        {foreach key=key item=item from=$video_category_list name=category}
                                            <option value="{$item.vc_id}"{if $news_video_gallery.vg_vc_id == $item.vc_id} selected="selected"{/if}>{$item.vc_title_ru}</option>
                                        {/foreach}
                                    {/if}
                                </select>
                            </td>
					...
					<td width="50%" align="center" valign="middle">
						<input type="submit" name="save_edited_news_video" id="submitsave" value="Сохранить">
						<br><br><br>
						<input type="submit" name="delete_edited_news_video" id="submitdelete" value="Удалить">
					</td>
				</tr>
			</table>
			<br>
			...
			<tr>
				...
				<form method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<br>
						<input type="submit" name="save_edited_news_preview" id="submitsave" value="Перезаписать">
						</td>
					</tr>
				</form>
				</table>
