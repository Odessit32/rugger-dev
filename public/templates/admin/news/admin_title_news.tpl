...
{/literal}
		<b>Заголовки страницы новостей:</b><br><br>
		<!-- РУС -->
		<div id="news_1">
			...
			<input type="Hidden" name="cnv_name" value="news">
				<tr>
					<td width="10%">Заголовок: </td>
					<td width="65%" align="center"><input type="text" name="cnv_value" id="input100" value="{$conf_vars.rus.news}"></td>
		...
		<div id="news_2">
			...
			<input type="Hidden" name="cnv_name" value="news">
				<tr>
					<td width="10%">Заголовок: </td>
					<td width="65%" align="center"><input type="text" name="cnv_value" id="input100" value="{$conf_vars.ukr.news}"></td>
					<td width="25%" align="center"><input type="submit" name="save_var" id="submitsave" value="Сохранить"></td>
				</tr>
			</form>
			</table>
		...
		<div id="news_3">
			...
			<input type="Hidden" name="cnv_name" value="news">
				<tr>
					<td width="10%">Заголовок: </td>
					<td width="65%" align="center"><input type="text" name="cnv_value" id="input100" value="{$conf_vars.eng.news}"></td>
					<td width="25%" align="center"><input type="submit" name="save_var" id="submitsave" value="Сохранить"></td>
				</tr>
			</form>
			</table>
