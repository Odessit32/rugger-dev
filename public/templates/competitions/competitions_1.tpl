...
{if !empty($competition_list) && $competition_list|@count>1}
...
{if !empty($championship_item.description)}
    <div class="post">{$championship_item.description}</div>
{/if}

{if !empty($competition_data.standing)}
    {include file="competitions/standing_15.tpl"} {* Standing Table for 15 *}
{/if}
...
{if !empty($competition_data.games)}
    {include file="competitions/games_15.tpl"} {* Games for 15 *}
{/if}

{if !empty($competition_data.staff) && !empty($competition_data.show_stuff_rating)}
    {include file="competitions/staff_15.tpl"} {* Staff for 15 *}
{/if}
